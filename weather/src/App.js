...
library.add(faBarChart, faAreaChart, faPieChart, faProjectDiagram);
          ...
          <Toolbar>
            <Container maxWidth="xl">
              <Grid container>
                ...
                <MenuItem >
                  <Typography className='text-white' textAlign="center" variant={'h6'}>Navigation Item 1 <FontAwesomeIcon icon={["fas", "fa-chart-pie"]} /></Typography>
                </MenuItem>
                <MenuItem >
                  <Typography className='text-white' textAlign="center" variant={'h6'}>Navigation Item 2 <FontAwesomeIcon icon={['fas', 'fa-chart-bar']} /></Typography>
                </MenuItem>
                <MenuItem >
                  <Typography className='text-white' textAlign="center" variant={'h6'}>Navigation Item 3 <FontAwesomeIcon icon={['fas', 'fa-project-diagram']} /></Typography>
                </MenuItem>
              </Grid>
            </Container>
          </Toolbar>
