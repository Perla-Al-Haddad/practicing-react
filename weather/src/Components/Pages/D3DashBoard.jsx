...
import PieChart from '../ChartComponents/D3PieChart/D3PieChart';
import BarChart from '../ChartComponents/D3BarChart/D3BarChart';
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={8} lg={7} >
                                <Section id={'Chart1DIV'}>
                                    <ChartBox height={680}  headerName="Chart Title 1">
                                        <PieChart />
                                    </ChartBox>
                                </Section>
                            </Grid>
                            <Grid item xs={12} md={4} lg={5} >
                                <Section id={'Chart2DIV'}>
                                    <ChartBox height={680} headerName="Chart Title 2">
                                        <BarChart />
                                    </ChartBox>
                                </Section>
                            </Grid>
